...
<header class="site-header">
  <div class="header-inner">
    ...
    <a href="contact.html#contact-form-container" class="header-cta">קבלו הצעת מחיר</a>
  </div>
</header>
...
<aside id="mobile-nav-drawer" class="mobile-nav-drawer" dir="rtl" aria-hidden="true">
  ...
  <nav class="mobile-nav-drawer__links" aria-label="תפריט מובייל">
    ...
    <a href="about.html">אודות</a>
    <a href="contact.html">צור קשר</a>
    <a href="contact.html#contact-form-container" class="mobile-nav-drawer__cta">קבלו הצעת מחיר</a>
  </nav>
</aside>
`;
