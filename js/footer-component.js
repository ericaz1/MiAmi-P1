  ...
  <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-12 text-center md:text-right">
    ...
    <div class="space-y-4 flex flex-col items-center md:items-start text-center md:text-right">
      ...
      <div class="flex gap-4 pt-4">
        ...
        <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-white/5 hover:bg-[#E1306C] hover:text-white transition-all flex items-center justify-center text-lg text-white/80">
          <i class="fa-brands fa-instagram"></i>
        </a>
        <a href="https://wa.me/97288522085" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-white/5 hover:bg-[#25D366] hover:text-white transition-all flex items-center justify-center text-lg text-white/80">
    ...
    <div class="space-y-4 flex flex-col items-center md:items-start text-center md:text-right">
      <h4 class="text-lg font-bold text-white uppercase tracking-wider relative pb-2 after:content-[''] after:absolute after:bottom-0 after:right-0 after:w-12 after:h-0.5 after:bg-mustard-accent">פרטי התקשרות</h4>
      <ul class="space-y-3 text-sm text-white/70 flex flex-col items-center md:items-start text-center md:text-right">
        ...
        <li class="flex items-center gap-2 justify-center md:justify-start">
          ...
          <a href="tel:08-8522085" class="hover:text-mustard-accent transition-colors">08-8522085</a>
        </li>
        <li class="flex items-center gap-2 justify-center md:justify-start">
          <span class="material-symbols-outlined text-mustard-accent text-lg">mail</span>
          <a href="mailto:info@miamihotel.co.il" class="hover:text-mustard-accent transition-colors">info@miamihotel.co.il</a>
        </li>
        <li class="flex items-center gap-2 justify-center md:justify-start">
          <span class="material-symbols-outlined text-mustard-accent text-lg">verified</span>
